...
```javascript
PI_SQUARED = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-pi-squared@v0.0.8-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-pi-squared@v0.0.8-umd/browser.js"></script>
```
